        ...
        <div class="container mt-5 pt-3">
            ...
            <div class="row my-5">
                ...
                <div class="col-md-6 col-lg-4 p-3">  
                    <div class="card">
                        <img src="../web/img/filtro/sistemas1.jpg" class="card-img-top" alt="unoest">
                        <div class="card-body">
                            <h5 class="card-title">SISTEMAS OPERACIONAIS</h5>
                            <p class="card-text">Curso de Sistemas Operacionais.</p>
                        </div>
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item">FATEC</li>
                            <li class="list-group-item">PRESIDENTE PRUDENTE</li>
                            <li class="list-group-item">Data: 23/01/2020</li>
                        </ul>
                        <div class="card-body">
                ...
                <div class="col-md-6 col-lg-4 p-3">  
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">Mini-curso de Algoritmo.</p>
                        </div>
                        <ul class="list-group list-group-flush">
                ...
                <div class="col-md-6 col-lg-4 p-3">  
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">Mini-curso de JSP.</p>
                        </div>
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item">FATEC</li>
                ...
                <div class="col-md-6 col-lg-4 p-3">  
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">Curso de Java.</p>
                        </div>
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item">UNOESTE</li>
                            <li class="list-group-item">PRESIDENTE PRUDENTE</li>
                            <li class="list-group-item"> Data: 14/02/2020</li>
                        </ul>
                        <div class="card-body">
                              <a href="#" class="card-link">MAIS INFORMAÇÕES</a>
                        </div>
                ...
                <div class="col-md-6 col-lg-4 p-3">  
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">Mini-curso de Data Mining. </p>
                        </div>
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item">FATEC</li>
                            <li class="list-group-item">PRESIDENTE PRUDENTE</li>
                            <li class="list-group-item"> Data: 19/02/2020</li>
                        </ul>
                        <div class="card-body">
                              <a href="#" class="card-link">MAIS INFORMAÇÕES</a>
                        </div>
                ...
                <div class="col-md-6 col-lg-4 p-3">  
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">Mini-curso de MySQL.</p>
                        </div>
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item">FATEC</li>
                            <li class="list-group-item">PRESIDENTE PRUDENTE</li>
                            <li class="list-group-item"> Data: 26/02/2020</li>
                        </ul>
                        <div class="card-body">
                              <a href="#" class="card-link">MAIS INFORMAÇÕES</a>
                        </div>
