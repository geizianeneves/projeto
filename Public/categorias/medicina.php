        ...
        <div class="container mt-5 pt-3">
            ...
            <div class="row my-5">
                ...
                <div class="col-md-6 col-lg-4 p-3">  
                    <div class="card">
                        <img src="../web/img/filtro/medicina1.jpg" class="card-img-top" alt="unoest">
                        <div class="card-body">
                            <h5 class="card-title">MEDICINA INTERATIVA</h5>
                            <p class="card-text">Mini-curso de Medicina Interativa.</p>
                        </div>
                ...
                <div class="col-md-6 col-lg-4 p-3">  
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">Curso de Medicina Corporativa.</p>
                        </div>
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item">USP</li>
                            <li class="list-group-item">SÃO PAULO</li>
                            <li class="list-group-item">Data: 21/01/2020</li>
                        </ul>
                        <div class="card-body">
                              <a href="#" class="card-link">MAIS INFORMAÇÕES</a>
                        </div>
                ...
                <div class="col-md-6 col-lg-4 p-3">  
                    <div class="card">
                        <img src="../web/img/filtro/medicina1.jpg" class="card-img-top" alt="unoest">
                        <div class="card-body">
                            <h5 class="card-title">MEDICINA ANIMAL</h5>
                            <p class="card-text">Palestra de Medicina Animal.</p>
                        </div>
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item">FATEC</li>
                            <li class="list-group-item">SÃO PAULO</li>
                            <li class="list-group-item"> Data: 03/02/2020</li>
                        </ul>
                        <div class="card-body">
                              <a href="#" class="card-link">MAIS INFORMAÇÕES</a>
                        </div>
                ...
                <div class="col-md-6 col-lg-4 p-3">  
                    <div class="card">
                        <img src="../web/img/filtro/medicina1.jpg" class="card-img-top" alt="unoest">
                        <div class="card-body">
                            <h5 class="card-title">MEDICINA DO TRABALHO</h5>
                            <p class="card-text">Palestra de Medicina do Trabalho.</p>
                        </div>
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item">UNOESTE</li>
                            <li class="list-group-item">PRESIDENTE PRUDENTE</li>
                            <li class="list-group-item"> Data: 16/02/2020</li>
                        </ul>
                        <div class="card-body">
                              <a href="#" class="card-link">MAIS INFORMAÇÕES</a>
                        </div>
                ...
                <div class="col-md-6 col-lg-4 p-3">  
                    <div class="card">
                        <img src="../web/img/filtro/medicina1.jpg" class="card-img-top" alt="unoest">
                        <div class="card-body">
                            <h5 class="card-title">MEDICINA LABORAL</h5>
                            <p class="card-text">Palestra de Medicina Laboral. </p>
                        </div>
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item">FATEC</li>
                            <li class="list-group-item">ADAMANTINA</li>
                            <li class="list-group-item"> Data: 21/02/2020</li>
                        </ul>
                        <div class="card-body">
                              <a href="#" class="card-link">MAIS INFORMAÇÕES</a>
                        </div>
                ...
                <div class="col-md-6 col-lg-4 p-3">  
                    <div class="card">
                        <img src="../web/img/filtro/medicina1.jpg" class="card-img-top" alt="unoest">
                        <div class="card-body">
                            <h5 class="card-title">MEDICINA CARDÍACA</h5>
                            <p class="card-text">Mini-curso de Medicina Cardíaca.</p>
                        </div>
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item">UNESP</li>
                            <li class="list-group-item">ASSIS</li>
                            <li class="list-group-item"> Data: 23/02/2020</li>
                        </ul>
                        <div class="card-body">
                              <a href="#" class="card-link">MAIS INFORMAÇÕES</a>
                        </div>
