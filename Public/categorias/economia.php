        ...
        <div class="container mt-5 pt-3">
            ...
            <div class="row my-5">
                ...
                <div class="col-md-6 col-lg-4 p-3">  
                    <div class="card">
                        <img src="../web/img/filtro/ecomomia1.jpg" class="card-img-top" alt="unoest">
                        <div class="card-body">
                            <h5 class="card-title">ECONOMIA BÁSICA </h5>
                            <p class="card-text">Mini-curso de economia e suas funções.</p>
                        </div>
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item">UNOESTE</li>
                            <li class="list-group-item">PRESIDENTE PRUDENTE</li>
                            <li class="list-group-item">Data: 28/12/2019</li>
                        </ul>
                        <div class="card-body">
                    ...
                    <div class="card">
                       <img src="../web/img/filtro/ecomomia1.jpg" class="card-img-top" alt="unoest">
                        <div class="card-body">
                            ...
                            <p class="card-text">Palestra sobre bolsa de valores no mercado nacional.</p>
                        </div>
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item">USP</li>
                            <li class="list-group-item">SÃO PAULO</li>
                            <li class="list-group-item">Data: 05/01/2020</li>
                        </ul>
                        <div class="card-body">
                              <a href="#" class="card-link">MAIS INFORMAÇÕES</a>
                        </div>
                ...
                <div class="col-md-6 col-lg-4 p-3">  
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">Mini-curso sobre cotações nacionais.</p>
                        </div>
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item">FATEC</li>
                            <li class="list-group-item">SÃO PAULO</li>
                            <li class="list-group-item"> Data: 10/01/2020</li>
                        </ul>
                        <div class="card-body">
                              <a href="#" class="card-link">MAIS INFORMAÇÕES</a>
                        </div>
                ...
                <div class="col-md-6 col-lg-4 p-3">  
                    <div class="card">
                        <img src="../web/img/filtro/ecomomia1.jpg" class="card-img-top" alt="unoest">
                        <div class="card-body">
                            <h5 class="card-title">GESTÃO DE EMPRESAS</h5>
                            <p class="card-text">Palestra sobre gestão de empresas.</p>
                        </div>
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item">UNOESTE</li>
                            <li class="list-group-item">PRESIDENTE PRUDENTE</li>
                            <li class="list-group-item"> Data: 15/01/2020</li>
                        </ul>
                        <div class="card-body">
                              <a href="#" class="card-link">MAIS INFORMAÇÕES</a>
                        </div>
                ...
                <div class="col-md-6 col-lg-4 p-3">  
                    <div class="card">
                       <img src="../web/img/filtro/ecomomia1.jpg" class="card-img-top" alt="unoest">
                        <div class="card-body">
                            <h5 class="card-title">BOVESPA</h5>
                            <p class="card-text">Curso sobre Bovespa, entre outros temas. </p>
                        </div>
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item">USP</li>
                            <li class="list-group-item">SÃO PAULO</li>
                            <li class="list-group-item"> Data: 04/02/2020</li>
                        </ul>
                        <div class="card-body">
                              <a href="#" class="card-link">MAIS INFORMAÇÕES</a>
                        </div>
                ...
                <div class="col-md-6 col-lg-4 p-3">  
                    <div class="card">
                        <img src="../web/img/filtro/ecomomia1.jpg" class="card-img-top" alt="unoest">
                        <div class="card-body">
                            <h5 class="card-title">MERCADO NACIONAL</h5>
                            <p class="card-text">Mini-curso sobre mercado internacional.</p>
                        </div>
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item">FATEC</li>
                            <li class="list-group-item">ADAMANTINA</li>
                            <li class="list-group-item"> Data: 28/02/2020</li>
                        </ul>
                        <div class="card-body">
                              <a href="#" class="card-link">MAIS INFORMAÇÕES</a>
                        </div>
