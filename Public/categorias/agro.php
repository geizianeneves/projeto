        ...
        <div class="container mt-5 pt-3">
            ...
            <div class="row my-5">
                ...
                <div class="col-md-6 col-lg-4 p-3">  
                    <div class="card">
                        <img src="../web/img/filtro/agro1.jpg" class="card-img-top" alt="unoest">
                        <div class="card-body">
                            <h5 class="card-title">AGRONOMIA </h5>
                            <p class="card-text">Palestra de Agronomia - Fatec Presidente Prudente</p>
                        </div>
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item">FATEC</li>
                            <li class="list-group-item">PRESIDENTE PRUDENTE</li>
                            <li class="list-group-item">Data: 15/12/2019</li>
                        </ul>
                        <div class="card-body">
                ...
                <div class="col-md-6 col-lg-4 p-3">  
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">Mini-curso de Agronegócio - Fatec Adamantina</p>
                        </div>
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item">FATEC</li>
                            <li class="list-group-item">ADAMANTINA</li>
                            <li class="list-group-item">Data: 20/12/2019</li>
                        </ul>
                        <div class="card-body">
                              <a href="#" class="card-link">MAIS INFORMAÇÕES</a>
                        </div>
                ...
                <div class="col-md-6 col-lg-4 p-3">  
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">Curso de Agropecuária para iniciantes</p>
                        </div>
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item">ETEC</li>
                            <li class="list-group-item">OSVALDO CRUZ</li>
                ...
                <div class="col-md-6 col-lg-4 p-3">  
                    <div class="card">
                        <img src="../web/img/filtro/agro1.jpg" class="card-img-top" alt="unoest">
                        <div class="card-body">
                            <h5 class="card-title">ECONOMIA NO AGRONEGÓCIO</h5>
                            <p class="card-text">Conceitos Básicos de Economia para o Agronegócio</p>
                        </div>
                        <ul class="list-group list-group-flush">
                ...
                <div class="col-md-6 col-lg-4 p-3">  
                    <div class="card">
                        <img src="../web/img/filtro/agro1.jpg" class="card-img-top" alt="unoest">
                        <div class="card-body">
                            <h5 class="card-title">TECNOLOGIA NA PECUÁRIA</h5>
                            <p class="card-text">Curso de aplicação de tecnologia na Pecuária</p>
                        </div>
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item">USP</li>
                            <li class="list-group-item">SÃO PAULO</li>
                            <li class="list-group-item"> Data: 20/01/2020</li>
                        </ul>
                        <div class="card-body">
                              <a href="#" class="card-link">MAIS INFORMAÇÕES</a>
                        </div>
                ...
                <div class="col-md-6 col-lg-4 p-3">  
                    <div class="card">
                        <img src="../web/img/filtro/agro1.jpg" class="card-img-top" alt="unoest">
                        <div class="card-body">
                            <h5 class="card-title">PRODUÇÃO AGROPECUÁRIA</h5>
                            <p class="card-text">Curso preparatório de Produção Agropecuária</p>
                        </div>
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item">FATEC</li>
                            <li class="list-group-item">ADAMANTINA</li>
