        ...
        <div class="row col-12 p-5">
            ...
            <div class="col-lg-4">
                <div class="card-body">
                    ...
                    <br>
                    <div class="card text-center">
                        <button class="btn btn-success" onclick="window.location.href='carrinho.php?id=<?= $eventos->getId() ?>'">Adicionar ao Carrinho
                        </button>
                    </div>
