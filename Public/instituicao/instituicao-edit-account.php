            ...
            <div class="container col-md-9 mt-5 pt-3">
                ...
                <div class="row">
                    ...
                    <div class="col-12 p-5">
                      <form class="mb-5" action="<?= BASE_URL . "controller/instituicao/atualizar.php" ?>" method="POST"
                          ...
                          <div class="form-group row">
                              ...
                              <div class="col-sm-10">
                                  <input type="text" class="form-control" id="inputNome" name="nome"
                                         value="<?= $_SESSION['dados']['nome'] ?>" required>                              </div>
                          </div>
                          <div class="form-group row">
                          ...
                          <div class="form-group row">
                              ...
                              <div class="col-sm-10">
                                  <input type="text" class="form-control" id="inputCnpj" name="cnpj"
                                         value="<?= $_SESSION['dados']['cnpj'] ?>" required>
                              </div>
                          </div>
                          <div class="form-group row">
                          ...
                          <input type="hidden" class="form-control" id="inputInstStatus" name="inst_status">
                          <button type="submit" name="bAtualizaInstituicao" class="btn btn-primary">Atualizar</button>
                      </form>
                        <button type="submit" name="bRemoveInstituicao" class="btn btn-primary"><a href="#" onclick="confirmaExclusao('http://projeto.test/public_html/controller/instituicao/deletar.php')" class="btn btn-primary">Excluir Perfil</a></button>
