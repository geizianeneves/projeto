...
<html lang="en" class="h-100">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="../web/css/estiloInstituicao.css">
        <!-- Bootstrap CSS -->
            ...
            <div class="container col-md-9 mt-5 pt-3">
                <div class="row">
                    ...
                    <table class="table table-hover m-5 py-3">
                        <tbody>
                            <tr>
                                <th class="font-weight-bold w-25" scope="row">Instituição:</th>
                                <td><?= $_SESSION['dados']['nome'] ?></td>
                            </tr>
                            <tr>
                                <th class="font-weight-bold w-25" scope="row">Usuário:</th>
                                <td><?= $_SESSION['dados']['usuario'] ?></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <th class="font-weight-bold w-25" scope="row">CNPJ:</th>
                                <td><?= $_SESSION['dados']['cnpj'] ?></td>
                            </tr>
                            <tr>
                                <th class="font-weight-bold w-25" scope="row">Telefone:</th>
                                <td><?= $_SESSION['dados']['fone'] ?></td>
                            </tr>
                            <tr>
