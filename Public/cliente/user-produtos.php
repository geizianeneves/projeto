...
<html lang="en" class="h-100">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="../web/css/userProdutos.css">
        <!-- Bootstrap CSS -->
                ...
                <div class="row col-12 p-5">
                    ...
                    <div class="card mb-5 border-0">
                        <div class="row no-gutters">
                            <div class="col-md-4">
                                <img src="../web/img/ticket/1.png" class="card-img" alt="...">
                            </div>
                            <div class="col-md-8">
                                    <div class="card-body">
                                    ...
                                    <ul class="list-group list-group-flush">
                                        <li class="list-group-item">UNOESTE / PRESIDENTE PRUDENTE</li>
                                        <li class="list-group-item">Data: 08/01/2020</li>
                                        <li class="list-group-item"><a href="#" class="card-link">MAIS INFORMAÇÕES</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card mb-5 border-0">
                        <div class="row no-gutters">
                            <div class="col-md-4">
                                <img src="../web/img/ticket/2.png" class="card-img" alt="...">
                            </div>
                            <div class="col-md-8">
                                    <div class="card-body">
                                    ...
                                    <ul class="list-group list-group-flush">
                                        <li class="list-group-item">USP / SÃO PAULO</li>
                    ...
                    <div class="card mb-5 border-0">
                        <div class="row no-gutters">
                            <div class="col-md-4">
                                <img src="../web/img/ticket/3.png" class="card-img" alt="...">
                            </div>
                            <div class="col-md-8">
                                    <div class="card-body">
                                    ...
                                    <ul class="list-group list-group-flush">
                                        <li class="list-group-item">FATEC / PRESIDENTE PRUDENTE</li>
