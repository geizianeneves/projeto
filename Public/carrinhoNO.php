            ...
            <div class="row col-12 p-5">
                ...
                <div class="card mb-5 border-0">
                    ...
                    <div class="row no-gutters">
                        <div class="col-md-2">
                            <img src="web/img/ticket/1.png" class="card-img card-body" alt="...">
                        </div>
                        <div class="col-md-6">
                                <div class="card-body">
                                <h5 class="card-title">ENGENHARIA ELÉTRICA</h5>
                                <p class="card-text">Curso com forte embasamento em física, matemática e nos
                            conceitos básicos de Engenharia Elétrica.</p>
                                <ul class="list-group list-group-flush">
                                    <li class="list-group-item">UNOESTE / PRESIDENTE PRUDENTE / Data: 10/12/2019</li>
                                </ul>
                                <p class="card-text mt-4"><a href="#">Deletar</a> | <a href="#">Salvar Para depois</a></p>
                            </div>
                        </div>
                        <div class="col-md-2">
                            <ul class="list-group list-group-flush">
                        ...
                        <div class="col-md-2">
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item"><h5 class="card-title">Preço R$ 10,00</h5></li>
                            </ul>
                        </div>
                    </div>
                </div>
                 ...
                 <div class="card mb-5 border-0">
                    <div class="row no-gutters">
                        ...
                        <div class="col-md-6">
                                ...
                                <p class="card-text">Curso de Medicina Ocupacional e seus conceitos básicos. Aborda os principais aspectos deste ramo
                            de atuação.</p>
                                <ul class="list-group list-group-flush">
                                    <li class="list-group-item">USP / SÃO PAULO / Data: 25/01/2020</li>
                                </ul>
                                <p class="card-text mt-4"><a href="#">Deletar</a> | <a href="#">Salvar para depois</a></p>
                            </div>
                        </div>
                        ...
                        <div class="col-md-2">
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item"><h5 class="card-title">Preço R$ 20,00</h5></li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-12 text-center mt-5">
                    <ul class="list-group list-group-flush">
                        <li class="list-group-item"><h5 class="card-title">Total:R$ 30,00</h5></li>
                    </ul>
                </div>
 
                <div class="col-md-12 text-center mt-5">
                    <a href="checkout.php" class="btn btn-danger">Ir para o Checkout</a>
                </div>
