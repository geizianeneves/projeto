                ...
                <div class="card col-sm-12 border-dark">
                    <div class="row">
                        <div class="col-md-8">
                            <div class="card-body">
                                <h2>INGRESSO </h2>
                                <h4> Participante: <?= $_SESSION['dados']['nome']?></h4>
                                <p class="card-text">Evento: <?= $eventos->getNome() ?> </p>
                                <p class="card-text">Local: <?= $eventos->getLocal() ?> </p>
                                <p class="card-text">Data e Horário: <?= $eventos->getDataHorario() ?> </p>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <img src="web/img/icones/qrcode.png" class="card-img" alt="image">
                        </div>
                    </div>
                </div>
