...
$instituicoesRepository = new \App\Model\Instituicao\InstituicaoRepository();


$instituicoes = $instituicoesRepository->getById($id);
...
//$instituicoes = $instituicoesRepository->getList([], ["id", "nome", "inst_status"]);
...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../web/css/instEditAccout.css">
    <!-- Bootstrap CSS -->
            ...
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                        <?php
                        /**
                         * @var $instituicao \App\Model\Instituicao\Instituicao
                         */
                        ?>
            ...
            <div class="container col-md-9 mt-5 pt-3">
                ...
                <div class="row">
                    ...
                    <div class="col-12 p-5">
                        <form class="mb-5" action="<?= BASE_URL . "controller/instituicao/atualizar.php" ?>"
                              method="POST"
                              id="form_instituicaoatual">
                            <input type="hidden" class="form-control" id="inputNome" name="id"
                                   value="<?= $instituicoes->getId() ?>"/>
                            <div class="form-group row">
                                <label for="inputNome" class="col-sm-2 col-form-label">Instituição: </label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="inputNome" name="nome"
                                           value="<?= $instituicoes->getNome() ?>" required></div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="inputUsuario" name="usuario"
                                           value="<?= $instituicoes->getUsuario() ?>" required>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="inputEmail" name="email"
                                           value="<?= $instituicoes->getEmail() ?>" required>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="inputCnpj" name="cnpj"
                                           value="<?= $instituicoes->getCnpj() ?>" required>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="inputFone" class="col-sm-2 col-form-label">Telefone: </label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="inputFone" name="fone"
                                           value="<?= $instituicoes->getFone() ?>" required>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="inputCep" name="cep"
                                           value="<?= $instituicoes->getCep() ?>" required>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="inputLogradouro" name="logradouro"
                                           value="<?= $instituicoes->getLogradouro() ?>" required>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="inputBairro" name="bairro"
                                           value="<?= $instituicoes->getBairro() ?>" required>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="inputNumero" name="numero"
                                           value="<?= $instituicoes->getNumero() ?>" required>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="clienteEstado">Estados: </label>
                                <div class="col-sm-10">
                                    <?php
                                    ...
                                    $cidadeId = $instituicoes->getCidadeId();
                            ...
                            <div class="form-group row">
                                <label for="clienteCidade">Cidades: </label>
                                <div class="col-sm-10">
                                    <?php
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <select name="inst_status" id="inputStatus" class="form-control" required>
                                        <option value="0" <?php if($instituicoes->getInstStatus() ==0) {
                                            echo "selected";
                                        } ?>>Nao Aprovado
                                        </option>
                                        <option value="1" <?php if($instituicoes->getInstStatus() ==1) {
                                            echo "selected";
                                        } ?>>Aprovado</option>
                                    </select>
                                </div>
                            ...
                            <button type="submit" name="bAtualizaInstituicao" class="btn btn-primary">Atualizar</button>
                        </form>
                        <button type="submit" name="bRemoveInstituicao" class="btn btn-primary"><a href="#"
                                                                                                   onclick="confirmaExclusao('http://projeto.test/public_html/controller/instituicao/deletar.php')"
