...
//$instituicoes = $instituicaoRepository->getList([], ["id", "nome", "cnpj", "fone", "inst_status"]);
        ...
        <div class="row">
            ...
            <div class="container col-md-9 mt-5 pt-3">
                    ...
                    foreach ($instituicoes as $instituicao){
                        if($instituicao->getInstStatus()==0){
                        ?>
                        <div class="card mb-5 border-0">
                        <div class="row no-gutters">
                            <div class="col-md-8">
                                    <div class="card-body">
                                    <h5 class="card-title"> Instituição: <?= $instituicao->getNome() ?></h5>
                                    <ul class="list-group list-group-flush">
                                        <li class="list-group-item"> CNPJ: <?= $instituicao->getCnpj() ?></li>
                                        <li class="list-group-item"> Telefone: <?= $instituicao->getFone()?> </li>
                                        <li class="list-group-item"> Status: <?= $instituicao->getInstStatus()?> </li>
                                        <a href="<?= BASE_URL.'admin/instituicao-edit-account-admin.php?id='.$instituicao->getId() ?>" class="btn btn-primary">EDITAR INSTITUIÇÃO</a>
                                    </ul>
                                </div>
                            </div>
                    </div>
