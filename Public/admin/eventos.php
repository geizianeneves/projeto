...
$eventos = $eventoRepository->getList([
                        ...
                        <div class="row no-gutters">
                            <div class="col-md-8">
                                    ...
                                    <ul class="list-group list-group-flush">
                                        ...
                                        <li class="list-group-item"> Status: <?= $evento->getEvStatus()?> </li>
                                        <a href="<?= BASE_URL.'admin/edit-evento-admin.php?id='.$evento->getId() ?>" class="btn btn-primary">EDITAR EVENTO</a>
                                    </ul>
                                </div>
                            </div>
                    </div>
