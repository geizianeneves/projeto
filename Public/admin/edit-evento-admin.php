                    ...
                    <div class="col-12 p-5">
                        <form class="mb-5" action="<?= BASE_URL . "controller/evento/atualizar.php" ?>" method="POST"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <select name="ev_status" id="inputStatus" class="form-control" required>
                                        <option value="0" <?php if($evento->getEvStatus() ==0) {
                                            echo "selected";
                                        } ?>>Nao Aprovado
                                        </option>
                                        <option value="1" <?php if($evento->getEvStatus() ==1) {
                                            echo "selected";
                                        } ?>>Aprovado</option>
                                    </select>
                                </div>
                        ...
                        <button type="submit" name="bRemoveEvento" class="btn btn-primary"><a href="#"
                                                                                              onclick="confirmaExclusao('http://projeto.test/public_html/controller/evento/deletar.php')"
