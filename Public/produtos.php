...
if (isset($_GET["instituicao_id"])){
    $instituicaoId = $_GET["instituicao_id"];
    $filtros[1] = [
...
$eventos = $eventosRepository->getList($filtros, $fields);
...
<head>
    ...
    <link rel="stylesheet" href="<?= BASE_URL ?>web/css/userProdutos.css"/>
</head>
        ...
        <div class="row col-lg-12 mt-5 pt-5">
            ...
            <div class="card center col-xl-2 col-md-4 col-6 border-0">
                <a href="categorias/engenharia.php">
                    <img src="web/img/icones/engenharia.png" class="card-img-top rounded-circle mx-auto d-block"
                            ...
                            <div class="col-md-6 col-lg-4 p-3">
                                <div class="card">
                                    <img src="<?= BASE_URL . 'media/tickets/' . $evento->getTicket() ?>"
                                         class="card-img-top" alt="<?= $evento->getNome() ?>">
                                    <div class="card-body">
                                        <h5 class="card-title"><?= $evento->getNome() ?></h5>
                                        <p class="card-text"><?= $cursoRepository->mostraNomeCurso($evento->getCursoId()) ?></p>
                                    </div>
                                    <ul class="list-group list-group-flush">
                                        <li class="list-group-item"><?= $evento->getLocal() ?></li>
                                        <li class="list-group-item"><?= $evento->getDataHorario() ?></li>
                                        <li class="list-group-item"><?= $evento->getDescricao() ?></li>
                                    </ul>
                                    <div class="card-body">
                                        <a href="pdp.php?id=<?= $evento->getId() ?>" class="card-link">MAIS INFORMAÇÕES</a>
                                    </div>
                                </div>
                            </div>
                        <?php } ?>
