            ...
            <div class="row col-12 p-5">
                ...
                <div class="card mb-5 border-0">
                    ...
                    <div class="row no-gutters">
                        ...
                        <div class="col-md-6">
                                <div class="card-body">
                                <h5 class="card-title"><?= $eventos->getNome() ?></h5>
                                <p class="card-text"><?= $eventos->getDescricao() ?></p>
                                <ul class="list-group list-group-flush">
                                    <li class="list-group-item"><?= $eventos->getLocal() ?> || <?= $eventos->getDataHorario() ?> ||
                                        <?= $nomeCity->mostraNomeCidade($eventos->getCidadeId()) ?> -
                                        <?= $nomeState->getEstadoNome($eventos->getCidadeId()) ?>
                                    </li>
                                </ul>
                                <p class="card-text mt-4"><a href="carrinho-vazio.php">Deletar</a> | <a href="#">Salvar Para Depois</a></p>
                            </div>
                        </div>
                        <div class="col-md-2">
                            <ul class="list-group list-group-flush">
                        ...
                        <div class="col-md-2">
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item"><h5 class="card-title"> R$ <?= $eventos->getPrecoNormal() ?></h5></li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-12 text-center mt-5">
                    <ul class="list-group list-group-flush">
                        <li class="list-group-item"><h5 class="card-title"> Total: R$ <?= $eventos->getPrecoNormal() ?></h5></li>
                    </ul>
                </div>
 
                <div class="col-md-12 text-center mt-5">
                    <a href="checkout.php?id=<?= $eventos->getId() ?>" class="btn btn-danger">Ir para o Checkout</a>
                </div>
